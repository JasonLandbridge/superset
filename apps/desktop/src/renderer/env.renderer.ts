...
const envSchema = z.object({
	...
	NEXT_PUBLIC_WEB_URL: z.string().default("https://app.superset.sh"),
	NEXT_PUBLIC_MARKETING_URL: z.string().default("https://superset.sh"),
	...
	RELAY_URL: z.string().default("https://relay.superset.sh"),
});
