 ...
 *
 * Activates inside any Superset terminal.
 * `notify.sh` routes v1 vs v2 internally — the extension just needs to fire.
 * If notify.sh is missing it's a no-op (Superset uninstalled / never installed).
 *
